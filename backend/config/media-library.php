...
return [
     ...
     */
    // Modello nostro: aggiunge site_id e BelongsToSite, cosi' i media
    // rientrano nella stessa garanzia di isolamento di Page e Post.
     ...
     */
    // Percorsi isolati per cliente: tenants/<tenant-id>/media/<id>/
    // Il default di Spatie userebbe solo l'id, mescolando i file di clienti
    // diversi nella stessa cartella (vedi TenantPathGenerator).
