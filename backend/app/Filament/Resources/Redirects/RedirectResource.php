...
class RedirectResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'reindirizzamento';

    protected static ?string $pluralModelLabel = 'reindirizzamenti';

    protected static ?string $navigationLabel = 'Reindirizzamenti';

    protected static ?string $recordTitleAttribute = 'da';
